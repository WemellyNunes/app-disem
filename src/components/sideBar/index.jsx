...
const Sidebar = ({ isCollapsed, toggleSidebar }) => {
  ...
  return (
    <>
      <div className={`hidden md:flex flex-col h-1/2 md:h-full bg-primary-green  border-r border-gray-300 md:fixed transition-all duration-300 ${isCollapsed ? 'w-12 md:w-14' : 'w-60'} transform` }>
